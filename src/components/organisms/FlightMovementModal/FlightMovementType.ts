...
export const getfisStsOptions = (fisFltSts: FisStsType | undefined, isEmergency: boolean, isOal: boolean | undefined): OptionType[] => {
  ...
  options.unshift({ label: fisFltSts || ("" as string), value: fisFltSts || ("" as string) }); // 選択されるようにfisFltStsがnullの場合は空文字に変換
  // 空白行を追加
