...
export interface ListItemEnabled {
  casFltFlg: boolean;
  fltName: boolean;
  orgDate: boolean;
  intDomCat: boolean;
  paxCgoCat: boolean;
  skdlNonskdlCat: boolean;
  depApoCd: boolean;
  arrApoCd: boolean;
  std: boolean;
  etd: boolean;
  sta: boolean;
  eta: boolean;
  shipTypeIataCd: boolean;
  shipNo: boolean;
  svcTypeDiaCd: boolean;
  onward: boolean;
  hideFlgCd: boolean;
  csFltNames: boolean;
  autoFocusColumn: FieldName | null;
}
...
export const getListItemEnabled = (fltSchedule: OalFlightSchedule): ListItemEnabled => {
  const listItemEnabled: ListItemEnabled = {
    casFltFlg: false,
    fltName: false,
    orgDate: false,
    intDomCat: false,
...
export const getMenuVisible = (index: number, fltScheduleList: OalFlightSchedule[]): MenuVisible => {
  const menuVisible: MenuVisible = {
    edit: false,
    cnl: false,
    rin: false,
    skdTim: false,
...
export const getFltInfo = (fltSchedule: OalFlightSchedule) => ({
