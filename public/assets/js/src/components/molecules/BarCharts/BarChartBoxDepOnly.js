...
class BarChartBoxDepOnly extends react_1.default.PureComponent {
    render() {
        ...
        const isBlackFontColorOnSvg = groundWorkStatus !== selector_1.WorkStatus.done;
        let wave = "";
        ...
        return (react_1.default.createElement(Wrapper, { clickable: clickable },
            react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: `-5 0 ${width + triangleWidth + 10} ${triangleHeight + 10}`, style: { width: width + triangleWidth + 15, height: triangleHeight + 10, filter: "drop-shadow(0px 3px 4px rgba(0,0,0,0.4))" } },
                react_1.default.createElement("path", { className: "chartBody", d: `M 0 0 ${wave} L 0 ${triangleHeight} L ${width} ${triangleHeight} L ${width + triangleWidth} 0 L 0 0`, stroke: "transparent", fill: fillColor, strokeWidth: "0", onClick: clickBarOfSpotChangeMode })),
            isSelectedSpotNumber ? (react_1.default.createElement(SpotChangeSelectedBoxSvg, { isActive: isSelectedSpotNumber, xmlns: "http://www.w3.org/2000/svg", viewBox: `-5 -2.5 ${width + triangleWidth + 10} ${triangleHeight + 10}`, style: { width: width + triangleWidth + 15, height: triangleHeight + 10, filter: "drop-shadow(0px 3px 4px rgba(0,0,0,0.4))" } },
                react_1.default.createElement("path", { className: "chartBody", d: `M 0 -3 ${wave} L 0 ${triangleHeight} L ${width} ${triangleHeight} L ${width + triangleWidth} 0 L 0 0`, stroke: "#EA6512", strokeWidth: "5", fill: "rgba(234, 101, 18, 0.6)", onClick: clickBarOfSpotChangeMode }),
            ...
            react_1.default.createElement(ChartContentWrapper, null,
                react_1.default.createElement(ChartContent, { style: { minWidth: width }, isSpotChangeMode: isSpotChangeMode },
                    ...
                    extFisRow.arrFromCat > 0 && (react_1.default.createElement(ShipfromAlCdArea, { isBlack: isBlackFontColorOnSvg },
                        react_1.default.createElement(AirLineCode, null, extFisRow.arrFromCasFltNo ? (react_1.default.createElement(BarChartBoxFull_1.CasFltNo, { casFltNo: extFisRow.arrFromCasFltNo }, extFisRow.arrFromCasFltNo)) : (react_1.default.createElement(react_1.default.Fragment, null,
                            react_1.default.createElement("small", null, extFisRow.arrFromAlCd),
                            extFisRow.arrFromFltNo))),
                        extFisRow.arrFromCat === 1 && react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { icon: free_solid_svg_icons_1.faArrowRight, style: { height: 18, width: "0.875em" } }),
                        extFisRow.arrFromCat === 2 && react_1.default.createElement(CrossIcon, null))),
                    ...
                    react_1.default.createElement(ModalTriggerButton, { isBlack: isBlackFontColorOnSvg, onClick: () => handleFlightDetailList(extFisRow, true), disabled: !flightDetailEnabled },
                        react_1.default.createElement(AirLineCode, { className: "chartBody" }, extFisRow.depCasFltNo ? (react_1.default.createElement(BarChartBoxFull_1.CasFltNo, { casFltNo: extFisRow.depCasFltNo }, extFisRow.depCasFltNo)) : (react_1.default.createElement(react_1.default.Fragment, null,
...
exports.default = BarChartBoxDepOnly;
...
`;
const ShipfromAlCdArea = styled_components_1.default.div `
  background: none;
  border: none;
  text-align: left;
...
const CrossIcon = styled_components_1.default.img.attrs({ src: icon_cross_svg_1.default }) `
  ...
  height: 18px;
`;
//# sourceMappingURL=BarChartBoxDepOnly.js.map