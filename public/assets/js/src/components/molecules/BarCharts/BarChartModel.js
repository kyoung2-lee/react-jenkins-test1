...
exports.getBarChartLayout = void 0;
function getBarChartLayout({ extFisRow, cellWidth, cellHeight, rowIndex, }) {
    let width;
    // 到着便のみのバーの幅を取得
    ...
    let left = (extFisRow.flightTimeDayjs.minute() / 60 + extFisRow.flightTimeDayjs.hour()) * cellWidth + 24 * extFisRow.flightDayDiff * cellWidth;
    if (!extFisRow.xtaLcl && extFisRow.xtdLcl) {
        left -= width;
    }
    return { width, top, left };
}
exports.getBarChartLayout = getBarChartLayout;
