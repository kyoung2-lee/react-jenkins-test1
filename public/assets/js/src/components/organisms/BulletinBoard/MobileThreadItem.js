...
exports.MobileThreadItem = void 0;
const react_1 = __importDefault(require("react"));
const styled_components_1 = __importStar(require("styled-components"));
const ThreadTag_1 = require("./ThreadTag");
const MessagePostedAt_1 = require("./MessagePostedAt");
const MobileThreadItem = ({ active, onClick, ...thread }) => (react_1.default.createElement(Container, { active: active, onClick: () => onClick && onClick(thread.bbId) },
    react_1.default.createElement(Header, null,
        react_1.default.createElement(PostUserGroup, null, thread.jobCd),
        react_1.default.createElement(PostedAt, { value: thread.updateTime, jstFlg: thread.jstFlg })),
    react_1.default.createElement(Title, null, thread.bbTitle),
...
exports.MobileThreadItem = MobileThreadItem;
...
const TagCol = styled_components_1.default.div `
  padding: 0 2px;
`;
//# sourceMappingURL=MobileThreadItem.js.map