...
const minus_svg_component_1 = __importDefault(require("../../assets/images/icon/minus.svg?component"));
const RoundButtonSmallPlus = (props) => {
    ...
    return (react_1.default.createElement(ButtonBase, { onClick: !disabled ? onClick : undefined, disabled: disabled, ...otherProps },
        react_1.default.createElement(minus_svg_component_1.default, null)));
};
...
//# sourceMappingURL=RoundButtonSmallMinus.js.map